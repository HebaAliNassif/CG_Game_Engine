...
void CGEngine::Application::configureOpenGL() {
...
CGEngine::WindowConfiguration CGEngine::Application::getWindowConfiguration() {
...
void CGEngine::Application::setupCallbacks() {
